...
venue: "Kleinmond Library"      # brief name of host site without address (e.g., "Euphoric State University")
address: "44 5th Ave, Kleinmond, South Africa"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, 					# Euphoria")
...
latlng: "-34.335399,19.012628"  # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use 						# http://www.latlong.net/)
...
instructor: ["Senzo Mpungose", "Caroline F Ajilogba", "Mesfin Diro", "Martin Dreyer", "Erin Becker"] # boxed, comma-separated list of 					# instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Anelda van der Walt", "Juan Steyn"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
